        ...
        <>
            ...
            <Container maxWidth={false}>  
                ...
                <div className={styles.whiteBlockInfo}>
                    <Image src='/static/images/mainPage/first-whiteBlock-photo-first.png' alt='qwe' width={910} height={500}/>
                    <div>
                        <span>Carrier</span>
                        ...
                        <Button>Register as a Carrier</Button>
                    </div>
                </div>
                <div className={styles.whiteBlockInfo}>
                    <div>
                        ...
                        <Button>Register as a Receiver</Button>
                    </div>
                    <Image src='/static/images/mainPage/first-whiteBlock-photo-second.png' alt='qwe' width={910} height={500}/>
                </div>
            </Container>
            <Container className={styles.blueBlock} maxWidth={false}>
                ...
                <div className={styles.blueBlock_content}>
                    <div className={styles.content_part}>
                        <Image width={600} height={500} src='/static/images/mainPage/blueBlock-photo-first.png' alt='first'/>
                    ...
                    <div className={styles.content_part}>
                        ...
                        <Image width={600} height={500} src='/static/images/mainPage/blueBlock-photo-second.png' alt='first'/>
                    </div>
                    <div className={styles.content_part}>
                        <Image width={600} height={500} src='/static/images/mainPage/blueBlock-photo-third.png' alt='first'/>
                        <div className={styles.content_firstText}>
                            <span>Safety</span>
            ...
            <Container maxWidth={false}>  
                ...
                <div className={styles.whiteBlockInfo}>
                    <Image src='/static/images/mainPage/second-whiteBlock-photo-first.png' alt='qwe' width={910} height={500}/>
                    <div>
                        <span>1. Choose</span>
                ...
                <div className={styles.whiteBlockInfo}>
                    ...
                    <Image src='/static/images/mainPage/second-whiteBlock-photo-second.png' alt='qwe' width={910} height={500}/>
                </div>
                <div className={styles.whiteBlockInfo}>
                    <Image src='/static/images/mainPage/second-whiteBlock-photo-third.png' alt='qwe' width={910} height={500}/>
                    <div>
